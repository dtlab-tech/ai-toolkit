...
| Agent | Task | Model | Tokens Est. | Tokens Actual |
|-------|------|-------|------------|--------------|
| developer-backend | Implement BE/INFRA tasks | sonnet | 155,000 | — |
| developer-testing | Implement TEST tasks | sonnet | 32,000 | — |
| review-solution (×5) | Architect review per US | sonnet | 40,000 | — |
...
| Phase 2 — Work Breakdown | — | — (filled by orchestrator) |
| Phase 3 — Implementation | 245,000 | — |
| **Total** | **245,000** | **— (partial — Phase 1, 2 & 3 pending)** |
