...
|-------|-------|-------|---------|-----------|-----------|-------------|-------------|
| INFRA | Shared Infrastructure | 1 | BE | 2h | 20min | — | — |
| US-01 | Implement `readManifest()` Function | 3 | BE, TEST | 5h | 50min | — | — |
| US-02 | Implement `computeOrphans()` Function | 3 | BE, TEST | 5h | 50min | — | — |
| US-03 | Implement `moveToTrash()` Function | 3 | BE, TEST | 5h | 50min | — | — |
| US-04 | Implement `writeManifest()` Function | 3 | BE, TEST | 5h | 50min | — | — |
| US-05 | Integrate Prune Phase into `runInstall()` and Add UI Display | 4 | BE | 8h | 80min | — | — |
| US-06 | Add CI Safety Net — Agent Name-to-Filename Alignment Check | 2 | TEST | 2h | 20min | — | — |
| **Total** | | **22** | | **~60h** | **~240min** | **—** | **—** |
